...
export class AddGenericSubscriptionRequest {
    'planId': number;
    'trialDays'?: number;
    'keepPrevTrialEndsAt': boolean;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "keepPrevTrialEndsAt",
            "baseName": "keep_prev_trial_ends_at",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return AddGenericSubscriptionRequest.attributeTypeMap;
    }
}
